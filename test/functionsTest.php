...
class FunctionTest extends TestCase
{
   ...
   public function testProcessData_returnsAString_success() {
       ...
       $testArray = [
           ['id' => 1, 'common_name' => 'American Persimmon', 'latin_name' => 'Diospyros virginiana', 'canopy_level' => 'CANOPY LAYER', 'life_span' => 60],
    ...
    public function testDisplayImage_MalformedTest() {
        ...
        $testArray = ['identification_image' => './images/american-persimmon.jpg', 'id' => 5, 'latin_name' => 'Diospyros virginiana'];
